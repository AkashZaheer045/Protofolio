...
const ContactForm = () => {
  ...
  return (
    <section
      id="contact"
      className="py-20 px-6 md:px-16 bg-gray-950 relative"
    >
      <div className="absolute inset-0 bg-gradient-to-t from-gray-900 via-transparent to-transparent opacity-50 pointer-events-none"></div>

      <h2 className="text-3xl md:text-5xl font-bold text-center mb-16 text-white relative z-10">
        Get In Touch
      </h2>

      <div className="flex flex-col md:flex-row gap-10 max-w-5xl mx-auto relative z-10">
        {/* Contact Info Card */}
        <div className="flex-1 bg-gray-900/80 backdrop-blur border border-gray-800 rounded-2xl p-8 flex flex-col justify-between shadow-2xl">
          <div>
            ...
            <ul className="space-y-6">
              <li className="flex items-center gap-4 text-gray-300">
                ...
                <a href="tel:+923320594296" className="hover:text-cyan-400 transition">
                  +92 332-0594296
                </a>
              </li>
              <li className="flex items-center gap-4 text-gray-300">
                ...
                <a href="mailto:akashzaheer786@gmail.com" className="hover:text-cyan-400 transition">
          ...
          <div className="mt-10">
            <h4 className="text-sm text-gray-500 uppercase tracking-widest mb-4">Follow Me</h4>
            <div className="flex gap-4">
              <a
                href="https://github.com/BitAnon47"
                target="_blank"
                rel="noreferrer"
                className="w-12 h-12 rounded-full bg-gray-800 border border-gray-700 flex items-center justify-center text-gray-400 hover:text-white hover:border-cyan-500 hover:bg-gray-700 transition-all duration-300"
              >
        ...
        {/* Form */}
        <form
          className="flex-1 bg-gray-900 border border-gray-800 rounded-2xl p-8 flex flex-col gap-6 shadow-2xl"
        ...
        >
          ...
          <div>
            ...
            <textarea
              ...
              name="message"
              rows="5"
              className="w-full px-4 py-3 rounded-lg bg-gray-800 border border-gray-700 text-white focus:outline-none focus:border-cyan-500 transition-colors resize-none"
